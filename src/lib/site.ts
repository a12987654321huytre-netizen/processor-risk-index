export const APP_NAME = "Processor Risk Index";
export const APP_SHORT = "PRI";
export const TAGLINE = "Your payment processor is not your bank.";
export const SUBLINE =
  "See which payment platforms are most likely to create headaches around account reviews, reserves, frozen payouts and sudden shutdowns — and what merchants use instead.";
...
export const NAV = [
  ...
  { to: "/how-cooked", label: "How cooked?" },
  { to: "/escape", label: "Escape hatch" },
